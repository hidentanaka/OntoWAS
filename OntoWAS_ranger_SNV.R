...
data.dt <- fread("inputfile_SNV.csv")
head(data.dt)
...
sink('Phenotypename_SNV_test1.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_SNV_test2.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_SNV_test3.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_SNV_test4.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_SNV_test5.txt', append = TRUE)
print (PIMP)
sink()
