...
data.dt <- fread("inputfile_OntoT.csv")
head(data.dt)
...
sink('Phenotypename_OntGO_test1.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_OntGO_test2.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_OntGO_test3.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_OntGO_test4.txt', append = TRUE)
print (PIMP)
sink()
...
sink('Phenotypename_OntGO_test5.txt', append = TRUE)
print (PIMP)
sink()
